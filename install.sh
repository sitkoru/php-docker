...
apt update && apt install -y \
    ...
    && if [[ ! $PHP_VERSION =~ $php8pattern ]]; then docker-php-ext-configure gd --with-freetype-dir=/usr/include/ --with-jpeg-dir=/usr/include/; else docker-php-ext-configure gd --with-freetype --with-jpeg; fi \
